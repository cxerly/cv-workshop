...
export default function Experiences() {
  ...
  console.log("staten er satt", selectedExperience);
    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.experiences}>
          ...
          {filteredExperiences().sort((a, b) => new Date(a.startDate).getTime() - new Date(b.startDate).getTime()).map(e => <div className={styles.container}><ExperienceCard key={e.id} experience={e} /></div>)}
